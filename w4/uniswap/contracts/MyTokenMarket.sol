...
contract MyTokenMarket {
    ...
    function AddLiquidity(uint tokenAmount) public payable {
        ...
        IUniswapV2Router02(router).addLiquidityETH{value: msg.value}(myToken, tokenAmount, 0, 0, msg.sender, block.timestamp);
    ...
    function buyToken(uint minTokenAmount) public payable {
        ...
        IUniswapV2Router02(router).swapExactETHForTokens{value : msg.value}(minTokenAmount, path, msg.sender, block.timestamp);
    }
